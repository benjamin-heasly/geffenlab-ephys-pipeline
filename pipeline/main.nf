...
process geffenlab_openephys_events {
    ...
    mkdir -p results/events/testing
    echo "0.0" > results/events/testing/test-events.txt
    echo "1.0" >> results/events/testing/test-events.txt
    echo "2.0" >> results/events/testing/test-events.txt
    """
}
